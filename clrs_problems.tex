...
\begin{minipage}{\textwidth}
	\lstinputlisting[language=C++, caption=Insertion Sort,linerange=begin:insertion_sort-end:insertion_sort]{code/src/insertion-sort.hpp}\label{listing:insertion_sort}
\end{minipage}
